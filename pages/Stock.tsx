    ...
    <div className="space-y-6 animate-in slide-in-from-right-2 duration-300 pb-20">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500">Record incoming inventory deliveries.</p>
        </div>
        <button 
          ...
          <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl p-8 transform animate-in zoom-in-95 duration-200">
            ...
            <div className="space-y-4">
              <div>
                ...
                <select 
                  className="w-full px-4 py-3 rounded-xl border bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:bg-white transition-all appearance-none"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    type="number"
                    className="w-full px-10 py-3 rounded-xl border bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:bg-white transition-all font-mono"
